...
public CarritoEntity {
    ...
    public int getEstado_carrito() {return estado_carrito;}
    public void setEstado_carrito(Boolean estado_carrito) {this estado_carrito = estado_carrito;}

    public int getCantidad_elementos() {return cantidad_elementos;}
    public void setCantidad_elementos(int cantidad_elementos) { this.cantidad_elementos = cantidad_elementos;}

    public int getTotal_pago() {return total_pago;}
    public void setTotal_pago(num total_pago) {this total_pago = total_pago;}
